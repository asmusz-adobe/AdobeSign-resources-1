...
*  Once all concerns have been addressed, your app will be certified and you will be able to make it available to your customers for general use.  If your integration functionality, or permissions related to your app need to change in the future, the application will need to be re-certified.
